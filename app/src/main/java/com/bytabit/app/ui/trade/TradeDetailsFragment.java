...
public class TradeDetailsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        compositeDisposable.add(fundEscrowButtonObservable
                ...
                .flatMapMaybe(v -> tradeManager.flatMapMaybe(TradeManager::fundEscrow))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
        ...
        compositeDisposable.add(paymentSentButtonObservable
                ...
                .observeOn(Schedulers.io())
                .flatMapMaybe(ref -> tradeManager.flatMapMaybe(tm -> tm.buyerSendPayment(ref)))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnError(this::showError).retry()
                .subscribe(trade -> {
        ...
        compositeDisposable.add(paymentReceivedButtonObservable
                ...
                .doOnNext(v -> disableEditorAndButtons())
                .observeOn(Schedulers.io())
                .flatMapMaybe(v -> tradeManager.flatMapMaybe(TradeManager::sellerPaymentReceived))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnError(this::showError).retry()
                .subscribe(trade -> {
        ...
        compositeDisposable.add(arbitrateButtonObservable
                ...
                .doOnNext(v -> disableEditorAndButtons())
                .observeOn(Schedulers.io())
                .flatMapMaybe(v -> tradeManager.flatMapMaybe(TradeManager::requestArbitrate))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnError(this::showError).retry()
                .subscribe(trade -> {
