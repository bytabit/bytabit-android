...
import com.bytabit.ft.views.DepositView;
import com.bytabit.ft.views.WalletView;
...
//        addViewFactory(OFFER_DETAILS_VIEW, () -> (View) new OfferDetailsView().getView(OFFER_DETAILS_VIEW));
    ...
    public void postInit(Scene scene) {
        ...
        ((Stage) scene.getWindow()).getIcons().add(new Image(FiatTraderMobile.class.getResourceAsStream("/icon.png")));
    }
}
