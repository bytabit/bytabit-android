    ...
    public void initialize() {
        ...
        offerDetailsView.showingProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if (newValue) {
                ...
                offerPubKeyLabel.textProperty().setValue(viewOffer.getPubKey());
                sellerPubKeyLabel.textProperty().setValue(viewOffer.getSellerPubKey());
                ...
                if (sellerPubKey.equals(viewOffer.getSellerPubKey())) {
